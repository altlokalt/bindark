  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[1080px] mx-[auto] overflow-auto relative w-[100%]">
        ...
        >
          <header className="flex items-center justify-center mb-[-9px] mx-[auto] w-[100%] z-[1]">
            <div className="flex items-center justify-center pt-[19px] px-[19px] w-[100%]">
              <div className="flex flex-col items-center justify-center md:w-[100%] w-[75%]">
                <div className="flex md:flex-col flex-row md:gap-[40px] items-center justify-between w-[100%]">
                  <div className="flex md:flex-1 md:flex-col flex-row md:gap-[40px] items-center justify-between md:w-[100%] w-[71%]">
                    ...
                    <ul className="flex sm:flex-col flex-row gap-[40px] sm:hidden items-center justify-start w-[auto] common-row-list">
                ...
                <div className="bg-gray_901 flex flex-col items-start justify-end py-[8px] rounded-[8px] w-[10%] md:w-[100%]">
                  <div className="flex flex-col gap-[7px] justify-start mt-[2px] w-[100%]">
                    <Text
                  ...
                  <div className="flex flex-col gap-[8px] justify-start mt-[10px] w-[100%]">
                    <Text
                      className="font-normal md:ml-[0] ml-[12px] not-italic text-left text-white_A700 w-[auto]"
                      variant="body10"
                    >
                  ...
                  <Text
                    className="font-normal md:ml-[0] ml-[12px] mt-[9px] not-italic text-left text-white_A700 w-[auto]"
                    variant="body10"
                  >
                    FAQs
                  </Text>
...
export default HoverDarkPagePage;
