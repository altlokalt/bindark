...
const ProfileFavoritesDarkPage = () => {
  const tableData = React.useRef([
    {
      rowlable: "Sweet Baby #1",
      rowlableone: "Flow",
      rowlabletwo: "Fabian Johnson",
      rowlablethree: "images/img_user_gray_400.svg",
    },
    {
      rowlable: "Doug Ortega #1",
      rowlableone: "Tezos",
      rowlabletwo: "Polly Walters",
      rowlablethree: "images/img_user_gray_400.svg",
    },
    {
      rowlable: "Vincent Welch #1",
      rowlableone: "Ethereum",
      rowlabletwo: "Basil Slater",
      rowlablethree: "images/img_user_gray_400.svg",
    },
    {
      rowlable: "Alec Alvarado #1",
      rowlableone: "Flow",
      rowlabletwo: "Mirabelle Maldonado",
      rowlablethree: "images/img_user_gray_400.svg",
    },
    {
      rowlable: "Baz Fletcher #1",
      rowlableone: "Tezos",
      rowlabletwo: "Roderick Boyd",
      rowlablethree: "images/img_user_gray_400.svg",
    },
    {
      rowlable: "Bert Moore #1",
      rowlableone: "Ethereum",
      rowlabletwo: "Lucy Neal",
      rowlablethree: "images/img_user_gray_400.svg",
    },
    {
      rowlable: "Oriel Binder #1",
      rowlableone: "Tezos",
      rowlabletwo: "Hazel Middleton",
      rowlablethree: "images/img_user_gray_400.svg",
    },
  ]);
  const columnHelper = createColumnHelper();
  const column = [
    columnHelper.accessor("rowlable", {
      cell: (info) => (
        <div className="flex flex-row gap-[16px] items-start justify-start p-[4px]">
          <Img
            src="images/img_bookmark.svg"
            className="h-[18px] ml-[16px] mt-[40px] w-[18px]"
            alt="bookmark"
          />
          <Img
            src="images/img_qrcode.svg"
            className="h-[56px] mt-[20px] w-[56px]"
            alt="qrcode"
          />
          <Text
            className="font-bold mt-[38px] text-left text-white_A700 w-[auto]"
            as="p"
            variant="body8"
          >
            {info?.getValue()}
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-center justify-start min-w-[405px] p-[13px] md:w-[100%] w-[39%]"
    ...
    columnHelper.accessor("rowlableone", {
      cell: (info) => (
        <div className="flex flex-row gap-[6px] items-center justify-start">
          <Img
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-center justify-center min-w-[198px] pr-[13px] py-[13px] md:w-[100%] w-[19%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
    ...
    columnHelper.accessor("rowlabletwo", {
      cell: (info) => (
        <div className="flex flex-row gap-[8px] h-[84px] md:h-[auto] items-center justify-start">
          <div className="bg-gray_700 h-[28px] rounded-[50%] w-[28px]"></div>
          <Text
            className="capitalize font-normal not-italic text-left text-white_A700 w-[auto]"
            as="p"
            variant="body10"
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-center justify-center min-w-[275px] pr-[13px] py-[13px] md:w-[100%] w-[27%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
    ...
    columnHelper.accessor("rowlablethree", {
      cell: (info) => (
        <div className="flex flex-row items-start justify-between pr-[20px] py-[20px]">
          <Text
            className="font-bold mb-[2px] mt-[22px] text-right text-white_A700 w-[auto]"
            as="p"
            variant="body10"
          >
            0.45 Flow
          ...
          <Img
            src={info?.getValue()}
            className="h-[18px] mt-[23px] w-[18px]"
            alt="user"
          />
        </div>
      ),
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-center justify-center min-w-[172px] pr-[13px] py-[13px] md:w-[100%] w-[17%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
  ...
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-dmsans gap-[20px] items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="md:h-[1368px] h-[1776px] md:px-[20px] relative w-[100%]">
          <div className="absolute bottom-[0] flex inset-x-[0] items-center justify-start mx-[auto] w-[100%]">
            <div className="flex flex-col md:gap-[40px] gap-[80px] justify-start w-[100%]">
              <div className="flex flex-col gap-[40px] items-start justify-start md:ml-[0] ml-[615px] md:w-[100%] w-[auto]">
                ...
                <div className="flex flex-col gap-[40px] items-center justify-center md:w-[100%] w-[auto]">
                  <div className="overflow-auto w-[100%]">
                    <ReactTable
                      ...
                      rowClass={""}
                      headerClass="bg-gray_901 border-[1px] border-bluegray_900"
                    />
                  </div>
...
export default ProfileFavoritesDarkPage;
