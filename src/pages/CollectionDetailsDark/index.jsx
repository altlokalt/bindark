...
const CollectionDetailsDarkPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-gray_900 bg-no-repeat flex font-dmsans h-[2400px] items-center justify-start mx-[auto] w-[100%]"
        style={{ backgroundImage: "url('images/img_0175contactdark.png')" }}
      >
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex flex-col max-w-[1410px] mt-[20px] mx-[auto] md:px-[20px] relative w-[100%]">
            <div
              className="bg-cover bg-no-repeat flex h-[322px] items-end justify-start mx-[auto] p-[20px] w-[100%]"
              style={{ backgroundImage: "url('images/img_03.svg')" }}
            >
              <div className="flex flex-row gap-[6px] items-start justify-end mb-[236px] ml-[auto] w-[auto]">
                <Button
                  className="bg-gray_900 flex items-center justify-center min-w-[175px] px-[23px] py-[14px] rounded-[23px] sm:px-[20px] text-center w-[auto]"
                  leftIcon={
                    <Img
                ...
                <Button className="bg-gray_900 flex h-[46px] items-center justify-center p-[13px] rounded-[50%] w-[46px]">
                  <Img
                ...
                <Button className="bg-gray_900 flex h-[46px] items-center justify-center p-[14px] rounded-[50%] w-[46px]">
                  <Img
                    src="images/img_overflowmenu.svg"
                    className=""
                    alt="overflowmenu"
            ...
            <div className="flex flex-col gap-[16px] items-center justify-start mt-[-45px] mx-[auto] w-[auto] z-[1]">
              <Img
              ...
              <div className="flex flex-col items-center justify-start sm:w-[100%] w-[auto]">
                ...
                <Text
                  className="font-bold text-center text-indigo_A700 w-[auto]"
                  variant="body10"
                >
                  @8SIAN
                </Text>
          ...
          <div className="flex flex-col gap-[40px] items-start justify-start max-w-[1410px] mt-[59px] mx-[auto] md:px-[20px] w-[100%]">
...
export default CollectionDetailsDarkPage;
