...
const Homepage1DarkPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[7049px] mx-[auto] overflow-auto relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat md:h-[6875px] h-[7049px] inset-[0] justify-center m-[auto] md:px-[20px] w-[100%]"
        ...
        >
          <div className="absolute flex h-[max-content] inset-[0] items-center justify-center m-[auto] w-[100%]">
            <div className="flex flex-col justify-start w-[100%]">
              ...
              <div className="flex flex-col items-center justify-start md:ml-[0] ml-[232px] mt-[100px] md:w-[100%] w-[78%]">
                ...
                <div className="flex flex-col gap-[28px] items-center justify-start mt-[851px] md:w-[100%] w-[auto]">
                  <Text
                    className="capitalize text-left text-white_A700 w-[auto]"
                    variant="body2"
                  >
                ...
                <div className="flex flex-col gap-[35px] items-center justify-start mt-[100px] md:w-[100%] w-[99%]">
              ...
              <div className="bg-gray_700_63 flex items-center justify-start mt-[80px] p-[96px] sm:px-[20px] md:px-[40px] w-[100%]">
          ...
          <div className="absolute flex flex-col gap-[20px] inset-x-[0] justify-start mx-[auto] pt-[19px] px-[19px] top-[0] w-[100%]">
            <header className="flex items-center justify-center mx-[auto] w-[100%]">
              <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-center w-[100%]">
                ...
                <div className="flex flex-row gap-[12px] items-start justify-start md:ml-[0] ml-[97px] w-[auto]">
                  ...
                  <div className="bg-gray_700 h-[48px] w-[48px]"></div>
            ...
            <div className="flex items-center justify-start md:ml-[0] ml-[1274px] md:w-[100%] w-[17%]">
              <div className="bg-gray_901 flex flex-col items-start justify-center p-[20px] rounded-[10px] w-[100%]">
                <Text
                ...
                <div className="flex flex-col gap-[6px] items-start justify-start mt-[14px] md:w-[100%] w-[auto]">
                  <Text
                    className="capitalize font-normal not-italic text-left text-white_A700 w-[auto]"
                    variant="body10"
                  >
                  ...
                  <Text
                    className="capitalize font-bold text-indigo_A400 text-left w-[auto]"
                    variant="body7"
                  >
                    45.57 ETH
                  </Text>
                </div>
                <div className="flex flex-col gap-[5px] items-start justify-start mt-[12px] w-[100%]">
                  <Text
                    className="capitalize font-normal not-italic text-left text-white_A700 w-[auto]"
                    variant="body10"
                  >
                  ...
                  <div className="flex flex-row font-urbanist gap-[116px] items-center justify-between w-[auto]">
                    <Text
                ...
                <Line className="bg-bluegray_900 h-[1px] mt-[20px] w-[100%]" />
                <div className="flex flex-row gap-[12px] items-center justify-start mt-[19px] w-[auto]">
                  <Img
                ...
                <div className="flex flex-row gap-[12px] items-center justify-start mt-[16px] w-[auto]">
                  <Img
                ...
                <div className="flex flex-row gap-[12px] items-center justify-start mb-[12px] mt-[16px] w-[auto]">
                  <Img
        ...
        <div className="absolute flex flex-col gap-[40px] inset-x-[0] items-center justify-start max-w-[2130px] mx-[auto] md:px-[20px] top-[19%] w-[100%]">
...
export default Homepage1DarkPage;
