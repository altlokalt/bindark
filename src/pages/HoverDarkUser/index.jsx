  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[1080px] mx-[auto] overflow-auto relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat bottom-[0] md:h-[6875px] h-[7049px] inset-x-[0] mx-[auto] md:px-[20px] w-[100%]"
...
export default HoverDarkUserPage;
