...
const ItemDetailsAuctionsBidDarkPage = () => {
                ...
                <div className="flex flex-col gap-[41px] items-center justify-start w-[100%]">
                  <div className="flex flex-col items-start justify-start w-[100%]">
                    ...
                    <div className="flex flex-col gap-[24px] h-[267px] md:h-[auto] items-start justify-start max-w-[632px] mt-[39px] w-[100%]">
                      ...
                      <div className="flex flex-row gap-[28px] h-[208px] md:h-[auto] items-start justify-between w-[100%]">
                        <List
                          className="flex-col gap-[20px] grid items-start w-[auto]"
                          orientation="vertical"
                        >
                          <div className="flex flex-row gap-[12px] items-center justify-start my-[0] w-[187px]">
                            ...
                            <div className="flex flex-col gap-[4px] items-start justify-start w-[auto]">
                              <Text
                                className="font-medium font-rubik text-left text-white_A700 w-[auto]"
                                variant="body10"
                              >
                                <span className="text-white_A700 text-[15px] font-dmsans">
                                  1.35 ETH
                                </span>
                                <span className="text-white_A700 text-[14px]">
                                  {" "}
                                </span>
                                <span className="text-gray_400 text-[15px] font-dmsans font-normal not-italic">
                                  by
                                </span>
                                <span className="text-white_A700 text-[14px]">
                                  {" "}
                              ...
                              <Text
                                className="capitalize font-dmsans font-normal not-italic text-gray_400 text-left w-[auto]"
                                variant="body10"
                              >
                                3/26/2022, 7:28 AM
                              </Text>
                        ...
                        <div className="flex flex-row items-start justify-start w-[1%]">
...
export default ItemDetailsAuctionsBidDarkPage;
