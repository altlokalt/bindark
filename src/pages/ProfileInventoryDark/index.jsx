...
import { Button, Img, Text, ReactTable, Input } from "components";
import { createColumnHelper } from "@tanstack/react-table";

const ProfileInventoryDarkPage = () => {
  const tableData1 = React.useRef([
    {
      rowlable: "images/img_qrcode.svg",
      rowlableone: "Art",
      rowlabletwo: "Ethereum",
      rowlablethree: "0.45 Flow",
      rowlablefour: "4,915",
      rowlablefive: "images/img_overflowmenu_gray_400.svg",
    },
    {
      rowlable: "images/img_qrcode.svg",
      rowlableone: "Photography",
      rowlabletwo: "Stellite",
      rowlablethree: "0.45 Flow",
      rowlablefour: "4,915",
      rowlablefive: "images/img_overflowmenu_gray_400.svg",
    },
  ...
  const column1 = [
    columnHelper1.accessor("rowlable", {
      cell: (info) => (
        <div className="flex items-center justify-start">
          <Img
            src={info?.getValue()}
            className="h-[60px] ml-[10px] mt-[28px] w-[60px]"
            alt="qrcode"
          />
        </div>
      ),
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-start justify-start min-w-[166px] md:w-[100%] w-[16%]"
        ...
        >
          ...
          <Img
            ...
            className="h-[18px] w-[11px]"
            alt="arrowdown Three"
          />
        </div>
      ),
    }),
    columnHelper1.accessor("rowlableone", {
      cell: (info) => (
        <Text
          className="font-bold pb-[22px] pt-[35px] text-left text-white_A700"
          as="p"
          variant="body10"
        >
          {info?.getValue()}
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-start justify-start min-w-[168px] md:w-[100%] w-[16%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
    ...
    columnHelper1.accessor("rowlabletwo", {
      cell: (info) => (
        <div className="flex flex-row font-inter gap-[8px] items-start justify-start">
          <Img
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-start justify-center min-w-[199px] md:w-[100%] w-[19%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
    ...
    columnHelper1.accessor("rowlablethree", {
      cell: (info) => (
        <Text
          className="font-bold pb-[23px] pt-[35px] text-left text-white_A700"
          as="p"
          variant="body10"
        >
          {info?.getValue()}
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-start justify-start min-w-[173px] md:w-[100%] w-[17%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
    ...
    columnHelper1.accessor("rowlablefour", {
      cell: (info) => (
        <Text
          className="font-bold pb-[21px] pl-[4px] pt-[35px] text-right text-white_A700"
          as="p"
          variant="body10"
        >
          {info?.getValue()}
      ...
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-start justify-end min-w-[146px] md:w-[100%] w-[14%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
    ...
    columnHelper1.accessor("rowlablefive", {
      cell: (info) => (
        <div className="flex flex-row font-dmsans items-center justify-between">
          <div className="flex flex-row gap-[11px] items-center justify-start mb-[12px] mt-[41px] outline outline-[0.5px] outline-bluegray_900 rounded-[18px] w-[auto]">
            <div className="bg-indigo_A700 h-[10px] rounded-[50%] w-[10px]"></div>
            <Text
              className="font-bold text-left text-white_A700 w-[auto]"
              as="p"
              variant="body11"
          ...
          <Img
            src={info?.getValue()}
            className="h-[20px] mr-[25px] w-[auto]"
            alt="overflowmenu"
          />
        </div>
      ),
      header: (info) => (
        <div
          className="common-pointer flex md:flex-1 flex-row gap-[9px] items-start justify-center min-w-[197px] md:w-[100%] w-[19%]"
          onClick={info.header.column.getToggleSortingHandler()}
        >
          <Text
            className="font-bold text-left text-white_A700 w-[auto]"
  ...
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-dmsans gap-[20px] items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="md:h-[1292px] h-[1702px] md:px-[20px] relative w-[100%]">
          <div className="absolute bottom-[0] flex inset-x-[0] items-center justify-start mx-[auto] w-[100%]">
            <div className="flex flex-col md:gap-[40px] gap-[80px] justify-start w-[100%]">
              <div className="flex flex-col gap-[40px] items-center justify-center md:ml-[0] ml-[615px] md:w-[100%] w-[auto]">
                <div className="flex flex-col gap-[40px] items-start justify-start md:w-[100%] w-[auto]">
                  ...
                  <div className="overflow-auto gap-[20px] w-[auto]">
                    <ReactTable
                      enableSorting
                      columns={column1}
            ...
            <div className="bg-gray_901 flex flex-col gap-[32px] items-center justify-center ml-[255px] mt-[-80px] sm:px-[20px] px-[24px] py-[40px] rounded-[18px] w-[auto] z-[1]">
              ...
              <div className="flex flex-col gap-[12px] items-start justify-start w-[282px]">
                <Input
                  ...
                  prefix={
                    <Img
                      src="images/img_folder_white_a700_20x20.svg"
...
export default ProfileInventoryDarkPage;
