...
const ExploreBannerDarkPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-gray_900 bg-no-repeat flex font-dmsans h-[2272px] items-center justify-start mx-[auto] w-[100%]"
        style={{
      ...
      >
        <div className="flex flex-col items-center justify-start w-[100%]">
          <header className="flex flex-col items-center justify-center md:px-[20px] w-[100%]">
            ...
            <div className="border-bluegray_900 border-solid border-t-[1px] flex flex-1 sm:flex-col flex-row gap-[16px] items-start justify-start max-w-[1920px] sm:px-[20px] px-[255px] md:px-[40px] py-[24px] w-[100%]">
              <Text
          ...
          <div className="flex flex-col md:gap-[40px] gap-[60px] items-start justify-start max-w-[1410px] mt-[9px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="h-[396px] md:h-[462px] relative md:w-[100%] w-[1410px]">
              <Text
                className="capitalize text-left text-white_A700 w-[auto]"
                variant="body2"
              >
              ...
              <div className="absolute h-[396px] md:h-[462px] inset-[0] justify-center m-[auto] w-[100%]">
                <div className="absolute bg-gradient26  bottom-[13%] flex md:flex-col flex-row md:gap-[40px] inset-x-[0] items-center justify-between mx-[auto] sm:px-[20px] px-[29px] rounded-[24px] w-[100%]">
                ...
                <Img
                  ...
                  className="absolute h-[396px] inset-y-[0] my-[auto] right-[7%] w-[396px]"
                  alt="IMG"
                />
              </div>
            </div>
            <div className="flex flex-col gap-[40px] items-center justify-start max-w-[1410px] w-[100%]">
...
export default ExploreBannerDarkPage;
