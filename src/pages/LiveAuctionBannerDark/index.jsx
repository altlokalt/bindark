...
const LiveAuctionBannerDarkPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[2320px] mx-[auto] relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat flex h-[max-content] inset-[0] items-center justify-center m-[auto] pb-[525px] w-[100%]"
        ...
        >
          <div className="flex flex-col gap-[17px] items-center justify-start w-[100%]">
            ...
            <div className="flex flex-col md:gap-[40px] gap-[60px] items-center justify-start max-w-[1410px] mx-[auto] md:px-[20px] w-[100%]">
              <div className="h-[330px] md:h-[462px] relative md:w-[100%] w-[1410px]">
                <Text
                  className="absolute capitalize left-[0] text-left text-white_A700 top-[0] w-[auto]"
                  variant="body2"
                >
                  Live Auctions Banner
                </Text>
                <div className="absolute h-[330px] md:h-[462px] inset-[0] justify-center m-[auto] w-[100%]">
                  <div className="absolute bg-gradient26  bottom-[0] flex md:flex-col flex-row md:gap-[40px] inset-x-[0] items-center justify-between mx-[auto] sm:px-[20px] px-[29px] rounded-[24px] w-[100%]">
                    <div className="flex md:flex-1 flex-col gap-[16px] items-start justify-start md:ml-[0] ml-[20px] md:w-[100%] w-[614px]">
                      <div className="flex flex-col gap-[12px] items-start justify-start sm:w-[100%] w-[auto]">
                        <div className="flex sm:flex-col flex-row gap-[12px] items-center justify-start sm:w-[100%] w-[auto]">
                          <Text
                            className="capitalize text-left text-white_A700 w-[auto]"
                            as="h6"
                            variant="h6"
                          ...
                          <Button className="bg-white_A700_33 cursor-pointer font-bold min-w-[113px] px-[12px] py-[6px] rounded-[15px] text-[14px] text-center text-white_A700 w-[auto]">
                            Coming soon
                          </Button>
                        </div>
                        <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                      ...
                      <Text
                        className="font-normal leading-[24.00px] md:max-w-[100%] max-w-[614px] not-italic text-gray_100 text-left"
                        variant="body8"
                      >
                    ...
                    <div className="h-[260px] relative md:w-[100%] w-[48%]">
                      <Img
                        src="images/img_intersect.svg"
                        className="absolute h-[260px] inset-y-[0] my-[auto] right-[0] w-[auto]"
                        alt="Blur"
                      />
                      <Img
                        src="images/img_checkmark_gray_700.svg"
                        className="absolute bottom-[0] h-[62px] left-[0] w-[auto]"
                        alt="checkmark"
                      />
                    </div>
                  </div>
                  <Img
                    ...
                    className="absolute h-[330px] inset-y-[0] my-[auto] right-[11%] w-[330px]"
                    alt="IMG"
                  />
                </div>
              </div>
        ...
        <footer className="absolute bg-gray_700_63 bottom-[0] flex inset-x-[0] items-center justify-center mx-[auto] md:px-[20px] w-[100%]">
          <div className="flex md:flex-col flex-row md:gap-[40px] items-center justify-between w-[74%]">
...
export default LiveAuctionBannerDarkPage;
