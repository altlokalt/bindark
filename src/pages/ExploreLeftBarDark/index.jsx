...
const ExploreLeftBarDarkPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-gray_900 bg-no-repeat flex font-dmsans h-[1961px] items-center justify-start mx-[auto] w-[100%]"
        style={{ backgroundImage: "url('images/img_0133exploreleft.png')" }}
      >
          ...
          <div className="flex items-center justify-start max-w-[1410px] mt-[21px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="flex flex-col gap-[34px] items-start justify-start w-[100%]">
              ...
              <div className="flex md:flex-col flex-row md:gap-[40px] items-center justify-between w-[100%]">
                ...
                <div className="md:h-[1088px] h-[1167px] relative md:w-[100%] w-[75%]">
                          ...
                          <div className="flex flex-col items-start justify-start w-[100%]">
                            ...
                            <div className="flex flex-row gap-[14px] items-center justify-start w-[100%]">
                              <div
                                ...
                                style={{
                                  backgroundImage:
                                    "url('images/img_img_26.png')",
                                }}
                              >
                                <Img
                                  src="images/img_bg_24.png"
                                  className="h-[40px] m-[auto] rounded-[50%] w-[40px]"
                                  alt="Bg Three"
                                />
                                <div className="absolute bg-gray_700 h-[40px] inset-[0] justify-center m-[auto] rounded-[50%] w-[40px]"></div>
                          ...
                          <div className="flex flex-col items-start justify-start w-[100%]">
                            ...
                            <div className="flex flex-row gap-[14px] items-center justify-start w-[100%]">
                              <div
                                ...
                                style={{
                                  backgroundImage:
                                    "url('images/img_img_27.png')",
                                }}
                              >
                                <Img
                                  src="images/img_bg_25.png"
                                  className="h-[40px] m-[auto] rounded-[50%] w-[40px]"
                                  alt="Bg Four"
                                />
                                <div className="absolute bg-gray_700 h-[40px] inset-[0] justify-center m-[auto] rounded-[50%] w-[40px]"></div>
                          ...
                          <div className="flex flex-col items-start justify-start w-[100%]">
                            ...
                            <div className="flex flex-row gap-[14px] items-center justify-start w-[100%]">
                              <div
                                ...
                                style={{
                                  backgroundImage:
                                    "url('images/img_img_28.png')",
                                }}
                              >
                                <Img
                                  src="images/img_bg_26.png"
                                  className="h-[40px] m-[auto] rounded-[50%] w-[40px]"
                                  alt="Bg Five"
                                />
                                <div className="absolute bg-gray_700 h-[40px] inset-[0] justify-center m-[auto] rounded-[50%] w-[40px]"></div>
...
export default ExploreLeftBarDarkPage;
