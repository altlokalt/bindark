...
const BlogDetails1DarkPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-gray_900 bg-no-repeat flex font-dmsans h-[3200px] items-center justify-start mx-[auto] w-[100%]"
      ...
      >
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex flex-col gap-[40px] items-start justify-start max-w-[930px] mt-[20px] md:px-[20px] w-[100%]">
            <div className="flex flex-col gap-[24px] items-start justify-start w-[100%]">
              <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                <Text
                  className="capitalize leading-[44.00px] md:max-w-[100%] max-w-[864px] text-center text-white_A700"
                  variant="body2"
                >
...
export default BlogDetails1DarkPage;
