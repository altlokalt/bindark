...
const FAQsDarkPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-gray_900 bg-no-repeat flex font-dmsans h-[2036px] items-center justify-start mx-[auto] w-[100%]"
      ...
      >
        <div className="flex flex-col items-center justify-start w-[100%]">
          ...
          <div className="flex flex-col md:gap-[40px] gap-[60px] items-center justify-start mt-[20px] md:px-[20px] md:w-[100%] w-[49%]">
            ...
            <div className="flex flex-col font-inter gap-[15px] items-start justify-start md:w-[100%] w-[auto]">
              <div className="flex flex-col items-start justify-start md:w-[100%] w-[auto]">
                <div className="bg-indigo_A700 flex flex-row gap-[10px] items-center justify-between max-w-[928px] px-[20px] py-[16px] rounded-bl-[0] rounded-br-[0] rounded-tl-[12px] rounded-tr-[12px] w-[100%]">
                  <Text
                    className="capitalize font-semibold text-left text-white_A700 w-[auto]"
                    variant="body5"
                  >
                    What is MiNFT ?
                  </Text>
                ...
                <div className="bg-gray_901 border-[1px] border-bluegray_900 border-solid flex items-center justify-start px-[20px] py-[16px] rounded-bl-[12px] rounded-br-[12px] rounded-tl-[0] rounded-tr-[0] md:w-[100%] w-[auto]">
                  <Text
                    className="font-normal leading-[26.00px] md:max-w-[100%] max-w-[888px] not-italic text-left text-white_A700"
                    variant="body8"
                  >
                    ...
                    magna eu orci. Porttitor magna nulla est amet dolor
                    ultricies egestas gravida. Nulla pellentesque convallis
                    ligula placerat consectetur tortor, lobortis velit risus.{" "}
                  </Text>
                </div>
              </div>
              <div className="bg-gray_901 border-[1px] border-bluegray_900 border-solid flex sm:flex-col flex-row gap-[10px] items-center justify-between max-w-[928px] px-[20px] py-[16px] rounded-[12px] w-[100%]">
                <Text
                  className="capitalize font-semibold text-left text-white_A700 w-[auto]"
                  variant="body5"
                >
              ...
              <div className="bg-gray_901 border-[1px] border-bluegray_900 border-solid flex flex-row gap-[10px] items-center justify-between max-w-[928px] px-[20px] py-[16px] rounded-[12px] w-[100%]">
                <Text
                  className="capitalize font-semibold text-left text-white_A700 w-[auto]"
                  variant="body5"
                >
          ...
          <div className="flex flex-col gap-[40px] items-center justify-start max-w-[1410px] mt-[80px] mx-[auto] md:px-[20px] w-[100%]">
            <Text
              className="capitalize text-left text-white_A700 w-[auto]"
              variant="body2"
            >
