  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[1080px] mx-[auto] overflow-auto relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat bottom-[0] md:h-[6087px] h-[7049px] inset-x-[0] mx-[auto] md:px-[20px] w-[100%]"
        ...
        >
          <div className="absolute bottom-[0] flex inset-x-[0] items-center justify-start mx-[auto] w-[100%]">
            <div className="flex flex-col md:gap-[40px] gap-[80px] items-center justify-start w-[100%]">
              <div className="flex flex-col items-center justify-start md:w-[100%] w-[78%]">
              ...
              <div className="bg-gray_700_63 flex items-center justify-start p-[100px] sm:px-[20px] md:px-[40px] w-[100%]">
          ...
          <div className="absolute md:h-[584px] h-[688px] right-[8%] top-[2%] md:w-[100%] w-[80%]">
                ...
                <div className="absolute bg-gradient1  mr-[178px] p-[2px] right-[15%] rounded-[29px] w-[43%] ">
                  <div className="absolute bg-gradient  bg-gray_900 border-solid flex items-center justify-start p-[23px] sm:px-[20px] right-[0] rounded-[29px] top-[0]">
                    <div
                      ...
                      style={{
                        backgroundImage: "url('images/img_img_507x450.png')",
                      }}
                    >
                      <Img
          ...
          <div className="absolute bg-gray_900_cc flex inset-x-[0] items-center justify-start mx-[auto] p-[227px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
            <div className="bg-gray_901 flex flex-col gap-[40px] items-center justify-center p-[40px] sm:px-[20px] rounded-[20px] md:w-[100%] w-[48%]">
              <div className="flex flex-col gap-[12px] items-center justify-start mt-[20px] w-[auto]">
                <Text
                  className="capitalize text-left text-white_A700 w-[auto]"
                  variant="body4"
                >
                ...
                <Text
                  ...
                  variant="body6"
                >
                  You must bid a least 4.89 ETH
                </Text>
              </div>
              <div className="flex flex-col items-start justify-start mb-[20px] w-[100%]">
                <div className="flex items-start justify-start md:w-[100%] w-[610px]">
                  <Input
                    className="capitalize font-normal not-italic px-[20px] py-[12px] text-[14px] placeholder:text-gray_400 text-gray_400 text-left w-[100%]"
                    wrapClassName="border-[1px] border-solid border-white_A700_19 rounded-[23px] w-[100%]"
                    name="ethCounter"
                    placeholder="00.00 ETH"
                  ></Input>
                </div>
                <Text
                  className="font-normal mt-[22px] not-italic text-left text-white_A700 w-[auto]"
                  variant="body8"
                >
                  Enter quantity 5 available
                </Text>
                <div className="flex items-start justify-start mt-[20px] md:w-[100%] w-[610px]">
                  <Text
                    className="border-[1px] border-solid border-white_A700_19 capitalize font-normal not-italic px-[20px] py-[12px] rounded-[23px] text-gray_400 text-left w-[100%]"
                    variant="body10"
                  >
                    1
                  </Text>
                </div>
                <div className="flex flex-row sm:gap-[40px] items-start justify-between mt-[30px] w-[100%]">
                  <Text
                    className="font-normal not-italic text-left text-white_A700 w-[auto]"
                    variant="body8"
                  >
                ...
                <div className="flex flex-row sm:gap-[40px] items-start justify-between mt-[20px] w-[100%]">
                  <Text
                    className="font-normal not-italic text-left text-white_A700 w-[auto]"
                    variant="body8"
                  >
                ...
                <Button className="bg-indigo_A700 cursor-pointer font-bold md:min-w-[100%] min-w-[610px] mt-[40px] py-[13px] rounded-[24px] text-[16px] text-center text-white_A700 w-[auto]">
                  Place bid
                </Button>
              </div>
            </div>
...
export default PopupPlaceBidPage;
