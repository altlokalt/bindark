        ...
        >
          <header className="flex items-center justify-center mb-[-9px] mx-[auto] w-[100%] z-[1]">
            <div className="flex flex-col items-center justify-center pt-[19px] px-[19px] w-[100%]">
              ...
              <div className="bg-gray_901 flex flex-col gap-[10px] items-start justify-end md:ml-[0] ml-[754px] mr-[986px] py-[8px] rounded-[8px] md:w-[100%] w-[8%]">
                <div className="flex flex-col gap-[8px] justify-start mt-[3px] w-[100%]">
                  <Text
...
export default HoverDarkExplorePage;
