...
const ExploreGridDarkPage = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-gray_900 bg-no-repeat flex font-dmsans h-[1952px] items-center justify-start mx-[auto] w-[100%]"
...
export default ExploreGridDarkPage;
