...
const ProfileFollowingDarkPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-dmsans gap-[20px] items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="md:h-[1378px] h-[1788px] md:px-[20px] relative w-[100%]">
                  ...
                  <div className="flex items-center justify-start w-[100%]">
                    <div className="flex items-center justify-start w-[100%]">
                      <div className="md:gap-[20px] gap-[30px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-[100%]">
                        <div className="border-[1px] border-bluegray_100_26 border-solid flex flex-1 items-end justify-start p-[20px] rounded-[16px] w-[100%]">
                          <div className="flex flex-col justify-start mb-[20px] mr-[2px] md:w-[100%] w-[81%]">
                            <div className="flex flex-row gap-[83px] items-start justify-end ml-[auto] md:w-[100%] w-[79%]">
                              <Img
                                src="images/img_qrcode.svg"
                                className="h-[80px] mt-[20px] w-[80px]"
                                alt="qrcode"
                              />
                              <Img
                            ...
                            <div className="flex flex-col gap-[4px] items-center justify-start md:ml-[0] ml-[43px] mt-[20px] w-[auto]">
                              <Text
                            ...
                            <Button className="bg-white_A700_19 cursor-pointer font-bold min-w-[183px] mr-[50px] mt-[46px] sm:px-[20px] md:px-[40px] px-[60px] py-[14px] rounded-[23px] text-[14px] text-center text-white_A700 w-[auto]">
                              Following
                            </Button>
                          </div>
                        </div>
                        <div className="border-[1px] border-bluegray_900 border-solid flex flex-1 items-end justify-start p-[20px] rounded-[16px] w-[100%]">
                          <div className="flex flex-col justify-start mb-[20px] mr-[2px] md:w-[100%] w-[80%]">
                            <div className="flex flex-row gap-[83px] items-start justify-end ml-[auto] md:w-[100%] w-[79%]">
                              <Img
                                src="images/img_qrcode.svg"
                                className="h-[80px] mt-[20px] w-[80px]"
                            ...
                            <div className="flex flex-col gap-[4px] items-center justify-start md:ml-[0] ml-[25px] mt-[20px] w-[auto]">
                              <Text
                                className="font-bold text-center text-white_A700 w-[auto]"
                                variant="body6"
                              >
                            ...
                            <Button className="bg-indigo_A700 cursor-pointer font-bold min-w-[179px] mr-[52px] mt-[46px] sm:px-[20px] md:px-[40px] px-[60px] py-[14px] rounded-[23px] text-[14px] text-center text-white_A700 w-[auto]">
                              Unfollow
                            </Button>
                          </div>
                        </div>
                        <div className="border-[1px] border-bluegray_100_26 border-solid flex flex-1 items-end justify-start p-[20px] rounded-[16px] w-[100%]">
                          <div className="flex flex-col justify-start mb-[20px] mr-[2px] md:w-[100%] w-[81%]">
                            ...
                            <div className="flex flex-col gap-[4px] items-center justify-start md:ml-[0] ml-[13px] mt-[19px] w-[auto]">
                              <Text
                                className="font-bold text-center text-white_A700 w-[auto]"
                                variant="body6"
                              >
                        ...
                        <div className="border-[1px] border-bluegray_100_26 border-solid flex flex-1 items-end justify-start p-[20px] rounded-[16px] w-[100%]">
                          <div className="flex flex-col justify-start mb-[20px] mr-[2px] md:w-[100%] w-[81%]">
                            ...
                            <div className="flex flex-col gap-[4px] items-center justify-start md:ml-[0] ml-[10px] mt-[20px] w-[auto]">
                              <Text
                                className="font-bold text-center text-white_A700 w-[auto]"
                                variant="body6"
                              >
...
export default ProfileFollowingDarkPage;
