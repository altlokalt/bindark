...
import { Button, Img, Text, Input, CheckBox, Line } from "components";
...
const SignupDarkPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[1360px] mx-[auto] relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat flex h-[max-content] inset-[0] items-center justify-center m-[auto] pb-[519px] w-[100%]"
          style={{
            backgroundImage: "url('images/img_0137exploregriddark.png')",
          }}
        >
          <div className="flex flex-col gap-[20px] items-center justify-start w-[100%]">
            ...
            <div className="flex flex-col gap-[40px] items-center justify-start md:px-[20px] md:w-[100%] w-[auto]">
              <Text
                className="capitalize text-left text-white_A700 w-[auto]"
                variant="body2"
              >
