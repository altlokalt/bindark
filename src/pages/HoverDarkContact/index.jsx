  ...
  return (
    <>
      <div className="bg-gray_900 font-dmsans h-[1080px] mx-[auto] overflow-auto relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat bottom-[0] flex h-[7049px] inset-x-[0] items-center justify-end mx-[auto] w-[100%]"
        ...
        >
          <div className="flex flex-col items-center justify-start w-[100%]">
            ...
            <div className="md:h-[670px] h-[688px] mt-[86px] md:px-[20px] relative md:w-[100%] w-[80%]">
            ...
            <div className="flex flex-col gap-[35px] items-center justify-start max-w-[1450px] mt-[100px] mx-[auto] md:px-[20px] w-[100%]">
              <Text
                className="capitalize text-left text-white_A700 w-[auto]"
                variant="body2"
              >
            ...
            <div className="flex flex-col gap-[28px] items-center justify-start max-w-[1410px] mt-[854px] mx-[auto] md:px-[20px] w-[100%]">
              <Text
                className="capitalize text-left text-white_A700 w-[auto]"
                variant="body2"
              >
            ...
            <div className="flex flex-col gap-[40px] items-center justify-start max-w-[1456px] mt-[100px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex flex-col gap-[40px] items-start justify-start max-w-[1410px] mt-[100px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex flex-col items-center justify-start max-w-[1410px] mt-[100px] mx-[auto] md:px-[20px] w-[100%]">
              <Text
                className="capitalize text-left text-white_A700 w-[auto]"
                variant="body2"
              >
            ...
            <div className="bg-gray_700_63 flex items-center justify-start mt-[80px] p-[100px] sm:px-[20px] md:px-[40px] w-[100%]">
              <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between max-w-[1410px] mx-[auto] w-[100%]">
                <div className="flex md:flex-1 flex-col items-start justify-start md:w-[100%] w-[22%]">
                  <div className="flex flex-row gap-[12px] items-center justify-start w-[auto]">
                    <Button className="bg-indigo_A700 flex h-[40px] items-center justify-center p-[8px] rounded-[50%] w-[40px]">
                      <Img
                        src="images/img_lightbulb.svg"
                ...
                <div className="flex md:flex-1 md:flex-col flex-row md:gap-[40px] items-start justify-between md:mt-[0] mt-[62px] md:w-[100%] w-[65%]">
                  <List
...
export default HoverDarkContactPage;
