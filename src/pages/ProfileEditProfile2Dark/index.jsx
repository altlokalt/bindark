...
const ProfileEditProfile2DarkPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_900 flex flex-col font-dmsans gap-[20px] items-center justify-start mx-[auto] w-[100%]">
        ...
        <div className="md:h-[1350px] h-[1758px] md:px-[20px] relative w-[100%]">
                    ...
                    <div className="flex flex-col gap-[20px] items-start justify-start md:w-[100%] w-[auto]">
                      ...
                      <div className="flex flex-col gap-[12px] items-start justify-start md:w-[100%] w-[auto]">
                        <div className="flex flex-col gap-[12px] items-start justify-start md:w-[100%] w-[auto]">
                          ...
                          <Input
                            className="font-bold px-[20px] py-[12px] text-[14px] text-left placeholder:text-white_A700 text-white_A700 w-[100%]"
                            wrapClassName="bg-gray_901 max-w-[1020px] rounded-[8px] w-[100%]"
                            name="Box"
...
export default ProfileEditProfile2DarkPage;
